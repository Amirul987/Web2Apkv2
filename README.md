...
```env
LOCAL_API_URL=http://152.42.160.143:2001
API_ID=your_api_id
...
server {
    ...
    location / {
        proxy_pass http://152.42.160.143:2001;
...
🌐 Web Dashboard:
   Local:   http://152.42.160.143:2001
   Network: http://192.168.x.x:2001
```
...
1. Buka `http://152.42.160.143:2001`
